...
//
//class PureModelTest extends AnyFlatSpec {
//
...
//
//
//    val filters = "this|$this.joined_date->dateDiff($this.birth_date,DurationUnit.YEARS)>20"
////    databricks::employee->getAll()->filter()
